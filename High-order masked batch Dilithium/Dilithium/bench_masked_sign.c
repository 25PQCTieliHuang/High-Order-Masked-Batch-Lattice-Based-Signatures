...
bench_vector[2] += masked_polyvec_matrix_pointwise_montgomery(&mw1, mat, &mz);
...
//uint8_t mus[N_MSG][CRHBYTES];
//uint8_t rhoprimes[N_MSG][CRHBYTES];
//keccak_state states[N_MSG];
/**/
